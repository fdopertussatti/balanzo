 ...
 * Fetches family membership for authorization decisions.
 */
@Component
public class AuthorizationContextResolver {
    ...
    /**
     * Builds context with user's active family IDs.
     */
    public AuthorizationContext resolve(UUID userId, AuthorizationContext.Operation operation) {
        ...
        return new AuthorizationContext(userId, familyIds, operation);
    }
}
